        ...
        <div id="Infos">
            <section className='AccueilBigProjectsSection'>
                ...
                <OneBigProject title={`Musée Théodore-Monod d'art africain`} image={ImageProject_1}
                    description={`Le Musée Théodore Monod a accueilli la restitution des résidences crea.sen, organisée en collaboration avec l'@ueausenegal.`}
                    color={'#000'} textcolor={'#f1f1f1'} theKey={2} The_Experience={false} The_Experience_Link={'https://villa-r-1.netlify.app/'} link={'/Articles_1'} side={'left'} />
                ...
                <OneBigProject title={'FORAFRICC 2023'} image={ImageProject_2}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={3} The_Experience={false} The_Experience_Link={'https://villa-r-1.netlify.app/'} link={'/Articles_1'} side={'right'} />
                ...
                <OneBigProject title={'Villa Saly'} image={ImageProject_3}
                    ...
                    color={'#000'} textcolor={'#f1f1f1'} theKey={4} The_Experience={false} The_Experience_Link={'https://villa-r-1.netlify.app/'} link={'/Articles_1'} side={'left'} />
